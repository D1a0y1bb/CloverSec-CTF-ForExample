...
<p align="center">
  <a href="https://github.com/D1a0y1bb/CloverSec-CTF-ForExample/releases"><img alt="Version" src="https://img.shields.io/badge/version-v1.1.2-2563eb"></a>
...
python3 scripts/search_recall_benchmark.py \
  ...
  --input-dir docs/validation/search-recall-v1.1.2 \
  --output docs/validation/search-recall-benchmark-v1.1.2.md \
  --json-output docs/validation/search-recall-benchmark-v1.1.2.json
```
...
Codex users can additionally validate against the local plugin-creator (`validate_plugin.py` under `~/.codex/skills/.system/plugin-creator/`). Bump the version with `scripts/bump_version.py` before a release; the Release title is the tag (e.g. `v1.1.2`) and the body's first line is `# CloverSec CTF For Example 1.1.2`.
