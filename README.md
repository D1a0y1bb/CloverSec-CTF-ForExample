...
<p align="center">
  <a href="https://github.com/D1a0y1bb/CloverSec-CTF-ForExample/releases/tag/v0.1.7"><img alt="Version" src="https://img.shields.io/badge/version-v0.1.7-2563eb?style=for-the-badge"></a>
...
```bash
codex plugin marketplace add D1a0y1bb/CloverSec-CTF-ForExample --ref v0.1.7
codex plugin list
...
```text
plugin version 0.1.7 -> git tag v0.1.7
```
