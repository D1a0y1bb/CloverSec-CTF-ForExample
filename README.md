...
<p align="center">
  <a href="https://github.com/D1a0y1bb/CloverSec-CTF-ForExample/releases"><img alt="Version" src="https://img.shields.io/badge/version-v0.7.1-2563eb"></a>
...
python3 scripts/search_recall_benchmark.py \
  ...
  --input-dir docs/validation/search-recall-v0.7.1 \
  --output docs/validation/search-recall-benchmark-v0.7.1.md \
  --json-output docs/validation/search-recall-benchmark-v0.7.1.json
```
...
发布前用 `scripts/bump_version.py` 更新版本号。Release 标题使用 tag，例如 `v0.7.1`；正文第一行使用 `# CloverSec CTF For Example 0.7.1`。
