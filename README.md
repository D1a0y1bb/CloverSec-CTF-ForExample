...
<p align="center">
  <a href="https://github.com/D1a0y1bb/CloverSec-CTF-ForExample/releases"><img alt="Version" src="https://img.shields.io/badge/version-v1.0.13-2563eb"></a>
...
`1.0.13` 按内部已经认可的真实题目归档样例调整输出，不再把英文过程文件当成最终交付入口。
...
```bash
codex plugin marketplace add D1a0y1bb/CloverSec-CTF-ForExample --ref v1.0.13
...
python3 scripts/search_recall_benchmark.py \
  ...
  --input-dir docs/validation/search-recall-v1.0.13 \
  --output docs/validation/search-recall-benchmark-v1.0.13.md \
  --json-output docs/validation/search-recall-benchmark-v1.0.13.json
```
...
发布前用 `scripts/bump_version.py` 更新版本号。Release 标题使用 tag，例如 `v1.0.13`；正文第一行使用 `# CloverSec CTF For Example 1.0.13`。
