...
- 未完成 Dockerizer 方案确认时，机器字段必须写：`confirmation_action=dockerizer`、`failure_category=platform_conversion_required`、`next_skill=cloversec-ctf-build-dockerizer`、`can_archive=false`。
